...
<spring:url value="/users/findsupok" var="revertokURL" /> 

<spring:url value="/users/findsuprevert" var="revertsupURL" /> 
  ...
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
   <a href="" class="w3-bar-item w3-button w3-padding-large w3-white">Home</a>
    ...
    <a href="" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"></a>
     ...
     <a href="" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"></a>
<%--      <a href="${superURL}" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Supervisor</a> --%>
